...
///Приведенный ниже код позволяет изменять стилевое оформление элемента(ов) при наведении указателя мыши. 
$("#line1 .line1_1").hover(
    	function () { $(this).addClass(".line1_1_1") },   //при наведении курсора на элемент
    	function () { $(this).removeClass(".line1_1") } //при уводе курсора с элемента
);